...
export const websiteAPI = {
  ...
  uploadBackgroundImage: (slug: string, imageFile: File) => {
    const formData = new FormData();
    formData.append("background_image", imageFile);
    return api.post(`/website/pages/${slug}/background-image`, formData, {
      headers: { "Content-Type": "multipart/form-data" },
    });
  },

  getBackgroundImageUrl: (slug: string) => api.get(`/website/pages/${slug}/background-image`),
};
