...
def downgrade() -> None:
    ...
    op.create_table('thread_category_associations',
    sa.Column('thread_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('category_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['category_id'], ['thread_categories.id'], name=op.f('thread_category_associations_category_id_fkey')),
    sa.ForeignKeyConstraint(['thread_id'], ['community_threads.id'], name=op.f('thread_category_associations_thread_id_fkey')),
