 ...
 * Can be used across different user types (merchants, nutritionists, mothers, etc.)
 *
 * @param productId - The ID of the product to display
 * @param backRoute - The route to navigate to when back button is pressed
 * @param showLikeButton - Whether to show the like/heart button (default: true)
 */
export const ProductDetailScreen: FC<ProductDetailScreenProps> = ({ productId, backRoute, showLikeButton = true }) => {
      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        ...
        <View style={styles.detailsCard}>
          ...
          <View style={styles.detailSection}>
            ...
            <Text style={styles.detailValue}>{product.merchant_name}</Text>
          </View>
        </View>
      </ScrollView>
    </SafeAreaView>
